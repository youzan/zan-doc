...
class swoole_http_server/* extends \swoole_server*/
{
    ...
    /**
     * on 设置 swoole_http_server 事件回调函数
     *
     * @since 3.0.4
     *
     * @param $event_name
     ...
     * http_parse_post 设置POST消息解析开关，选项为true时自动将Content-Type为x-www-form-urlencoded的请求包体解析到POST数组。
     *                 设置为false时将关闭POST解析。
     * ```
    ...
    /**
     * denyRequest worker process 拒绝服务?
     *
     * @since 3.0.4
     *
